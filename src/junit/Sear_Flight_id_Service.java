...
class Sear_Flight_id_Service {

	@Test
	void test()
	{
		service.Sear_Flight_id_Service ss = new service.Sear_Flight_id_Service();
		String flightid="01A";
		...
		list.add(f);
		assertEquals(list.toString(), ss.search(flightid).toString());
	}
