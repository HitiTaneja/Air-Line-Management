...
<div id="flight-search" class="container rounded mt-3 p-0">
		...
		<div class="w-100 ml-0 pt-2">
			<div class="row w-100 ml-0 py-2 text-center">
				<div class="col-md-2">
					<p><%=request.getAttribute("source")%></p>
				</div>
				<div class="col-md-2">
					<p><%=request.getAttribute("destination")%></p>
				</div>
				<div class="col-md-2">
					<p><%=request.getAttribute("jdate")%></p>
				</div>
				<div class="col-md-2">
					<p><%=request.getAttribute("passenger")%></p>
				</div>
			</div>
		</div>
		<div
		...
		<div class="w-100 ml-0 pt-2">
			...
			<div class="row w-100 ml-0 py-2 text-center">
				...
				<div class="col-md-2">
					...
					<input type="hidden" name="jdate" value="<%=request.getAttribute("jdate")%>">
